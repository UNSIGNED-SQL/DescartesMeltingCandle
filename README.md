...
For FamedArtist
  This is my final project using AI. It provides a social meda type site that will allow users to match with artist to create their designs. This is to assist local artists instead of users creating AI images. In doing so, the art community will thrive and AI can be used for other initiatives.
